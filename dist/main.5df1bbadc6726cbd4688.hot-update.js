...
var _WorkerListItem = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module '../WorkerListItem'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
  ...
  _createClass(WorkersList, [{
    ...
    value: function workersList() {
      return this.props.workers.map(function (worker, index) {
        return _react2.default.createElement(_WorkerListItem2.default, { worker: worker, key: index });
      });
    }
  }, {
    key: 'render',
...
//# sourceMappingURL=main.5df1bbadc6726cbd4688.hot-update.js.map