  ...
  _createClass(WorkersList, [{
    ...
    value: function workersList() {
      return this.props.workers.map(function (worker, index) {
        return _react2.default.createElement(_WorkerListItem2.default, { worker: worker, key: index, selectWorker: selectWorker });
      });
    }
  }, {
    key: 'render',
...
//# sourceMappingURL=main.b5ca1f63dba92353988d.hot-update.js.map