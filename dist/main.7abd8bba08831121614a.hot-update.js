  ...
  _createClass(Login, [{
    ...
    value: function validate() {
      ...
      if (!isEmailValid || password == "") {
        emailError = email == "" ? "Please provide valid email address" : null;
        passError = password == "" ? "Please provide valid password" : null;
        this.setState({ emailError: emailError, passError: passError });
      }

      emailError = this.validateEmail(email) ? null : "Please provide valid email address";
...
//# sourceMappingURL=main.7abd8bba08831121614a.hot-update.js.map