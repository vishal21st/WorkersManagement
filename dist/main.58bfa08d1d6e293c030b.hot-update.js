  ...
  return {
    login: function login(payload) {
      return new Promise(function (resolve, reject) {
        ...
        if (["vishal@wakecap.com", "hassan@wakecap.com"].includes(email.toLowerCase()) && password == "password") dispatch({ type: _actionTypes2.default.admin.LOGGING });
...
//# sourceMappingURL=main.58bfa08d1d6e293c030b.hot-update.js.map