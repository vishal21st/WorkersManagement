...
var Dashboard = function (_React$Component) {
  ...
  function Dashboard(props) {
    ...
    _this.state = { isShowSideBar: false };
    return _this;
  }
  ...
  _createClass(Dashboard, [{
    ...
    value: function toggleSideBar() {
      ...
      if (this.state.isShowSideBar) {
        debugger;
        this.refs.mainWrapper.classList.add('show-sidebar');
      } else {
        debugger;
        this.refs.mainWrapper.classList.remove('show-sidebar');
      }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'main-wrapper dashboard', refs: 'mainWrapper' },
        _react2.default.createElement(_SideBar2.default, null),
        _react2.default.createElement(
          'div',
          { className: 'page-content' },
          _react2.default.createElement(_Head2.default, { admin: admin, toggle: this.toggleSideBar.bind(this) }),
          _react2.default.createElement(_reactRouterDom.Route, { path: '/dashboard/workers', component: _Worker2.default })
        )
      );
    }
  }]);
...
//# sourceMappingURL=main.04c54233ddcac0450bcd.hot-update.js.map