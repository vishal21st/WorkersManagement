...
var SideBar = function (_React$Component) {
  ...
  function SideBar(props) {
    ...
    _this.state = {
      links: [{ label: "Dashboard", url: "/dashboard" }, { label: "Workers", url: "/dashboard/workers" }, { label: "Zones", url: "/zones" }, { label: "Reports", url: "/reports" }, { label: "Manage Site", url: "/site" }, { label: "Settings", url: "/settings" }]
    };
    return _this;
  }
    ...
    value: function renderLinks() {
      return this.state.links.map(function (link, index) {
        return _react2.default.createElement(
          'li',
          { className: 'sidebar-links__item', key: index },
          _react2.default.createElement(
            _reactRouterDom.NavLink,
            { activeClassName: 'active', className: 'sidebar-link', to: link.url },
            link.label
          )
        );
      });
...
//# sourceMappingURL=main.a015d833758704275200.hot-update.js.map