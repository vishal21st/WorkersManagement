  ...
  _createClass(WorkersList, [{
    ...
    value: function workersList() {
      ...
      return this.props.workers.map(function (worker, index) {
        ...
        return _react2.default.createElement(_WorkerListItem2.default, { isSelected: isSelected, key: index, worker: worker, selectWorker: _this2.props.selectWorker });
      });
    }
  }, {
    key: 'render',
...
//# sourceMappingURL=main.e484dbe73040b7913b05.hot-update.js.map