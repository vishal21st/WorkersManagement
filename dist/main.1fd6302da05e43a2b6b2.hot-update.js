  ...
  _createClass(WorkersList, [{
    ...
    value: function workersList() {
      ...
      return this.props.workers.map(function (worker, index) {
        return _react2.default.createElement(_WorkerListItem2.default, { worker: worker, key: index, selectWorker: _this2.props.selectWorker });
      });
    }
  }, {
    key: 'render',
...
//# sourceMappingURL=main.1fd6302da05e43a2b6b2.hot-update.js.map