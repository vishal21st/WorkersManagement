    ...
    login: function login(payload) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (["vishal@wakecap.com", "hassan@wakecap.com"].includes(email.toLowerCase()) && password == "password") {
          ...
          dispatch({ type: _actionTypes2.default.admin.LOGIN_SUCCESS, payload: { admin: admin, workers: workers } });
...
//# sourceMappingURL=main.4882b1f7cfa5a6eac9bc.hot-update.js.map